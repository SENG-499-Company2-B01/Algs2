...
def import_data():
    file_path_19_21 = 'data/client_data/Course_Summary_2019_2021.json'
    file_path_22_23 = 'data/client_data/Course_Summary_2022_2023.json'
...
def import_model(auto_retrain_model = False):
    global model
    
    model_path = "data/model_data/model.pkl"

    if not os.path.isfile(model_path) or auto_retrain_model:
